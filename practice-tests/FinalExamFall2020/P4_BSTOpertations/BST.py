...
class BST:
    ...
    def insert(self, value):
        if self.contains_value(value) is False:
        #if empty tree
            if self.root == None:
    ...
    def contains_value(self, value):
        return self.__contains_recur(self.root, value)

    def __contains_recur(self, root, value):
        ...
        if root.value > value:
            return self.__contains_recur(root.left, value)

        else:
            return self.__contains_recur(root.right, value)
